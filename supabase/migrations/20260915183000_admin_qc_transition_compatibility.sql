-- Keep the currently deployed admin completion action safe during the frontend rollout.
-- The new UI only offers completion after pilot submission, while the previous UI may
-- still call this service-role-only function from an accepted assignment.
