...
export function deliverableRevisionReady(params: {
  ...
  const revisionLabel = params.revisionNumber && params.revisionNumber > 1 ? `Revision ${params.revisionNumber}` : "The corrected revision";
  return {
    ...
    html: shell(
      ...
      `
        ...
        <p style="color:#444; line-height:1.5;">${escapeHtml(revisionLabel)} is now the active version and is ready for your approval.</p>
