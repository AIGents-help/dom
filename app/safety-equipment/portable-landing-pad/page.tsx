...
export default async function PortableLandingPadPage() {
  ...
  const description = product?.description ?? "A high-visibility foldable landing surface that creates a cleaner, more professional takeoff and landing point while helping protect the aircraft from loose dirt, grass, and debris.";
    ...
    <div className="min-h-screen bg-[#0b1118] text-white">
      ...
      <section className="container-app grid gap-10 pb-16 pt-4 lg:grid-cols-[1.08fr_.92fr] lg:items-center">
        ...
        <div>
          ...
          <QuantityBuyButton productKey="portable-landing-pad" unitPrice={unitPrice} />
